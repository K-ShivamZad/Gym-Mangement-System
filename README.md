...
1.  Clone the repository into your XAMPP `htdocs` folder:
    ```bash
    cd D:/xampp/htdocs
    git clone [https://github.com/K-ShivamZad/Gym-Mangement-System.git](https://github.com/K-ShivamZad/Gym-Mangement-System.git) gym_system
    ```
2.  Start **Apache** and **MySQL** from the XAMPP Control Panel.
3.  Import the database:
    * Open `http://localhost/phpmyadmin`
    * Create a new database named `gymsysdb`.
    * Import the `gymsysdb.sql` file provided in this repository.

### 3. Access the App
* URL: `http://localhost/gym_system/`
* **Default Credentials**: 
    * Username: `admin`
    * Password: `admin123`
